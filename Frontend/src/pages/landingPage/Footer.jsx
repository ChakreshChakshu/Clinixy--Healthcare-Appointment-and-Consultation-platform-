        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-20">
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="flex gap-4">
              {[Twitter, Linkedin, Instagram].map((Icon, i) => (
                <button key={i} className="w-9 h-9 rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center text-[#475569] dark:text-gray-400 hover:text-white hover:bg-[#10B981] transition-all duration-300 cursor-pointer shadow-sm">
                  <Icon size={14} />
                </button>
              ))}
            </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="relative group">
              <input type="email" placeholder="ENTER EMAIL" className="w-full bg-white dark:bg-white/5 border border-gray-300 dark:border-white/10 rounded-2xl px-5 py-4 text-[10px] font-bold uppercase tracking-widest focus:border-[#10B981] outline-none transition-all shadow-sm text-[#0F172A] dark:text-white" />
